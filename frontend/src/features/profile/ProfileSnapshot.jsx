    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          ...
          <p className="text-lg font-semibold text-gray-900">{safetyLevel}</p>
        </div>

        {/* Risk Level */}
        <div className="p-4 bg-gray-50 rounded-lg">
          <p className="text-sm text-gray-600 mb-1">Risk Level</p>
          <p className={`text-lg font-semibold text-${riskDisplay.color}-600`}>
            {riskDisplay.level}
          </p>
        </div>
        ...
        {/* Quiz Status */}
        <div className="p-4 bg-gray-50 rounded-lg">
          <p className="text-sm text-gray-600 mb-1">Safety Assessment</p>
        ...
        {/* Simulations */}
        <div className="p-4 bg-gray-50 rounded-lg">
          <p className="text-sm text-gray-600 mb-1">Simulations Completed</p>
          <p className="text-lg font-semibold text-gray-900">
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          ...
          <p className={`text-lg font-semibold text-${certStatus.color}-600`}>
            {certStatus.text}
          </p>
        </div>
      </div>
